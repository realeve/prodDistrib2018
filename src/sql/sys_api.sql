...
INSERT INTO `sys_api` VALUES ('81', '0000000002', '49', '机检弱项记废列表', 'a22afbf675', 'SELECT a.[品种],a.[号码信息],a.[车号],a.[工序],a.[设备],a.[机长],a.[类型],a.[张数],a.[记废等级],a.[缺陷图像],a.[备注],a.[登记时间] FROM view_print_machinecheck_weak a where 登记日期 between ? and ? order by a.[登记时间]', 'tstart,tend', '', '2018-04-09 18:00:54', '2018-04-24 14:23:06');
...
INSERT INTO `sys_api` VALUES ('100', '0000000014', '49', '车号最近生产工序', '97cfc715f4', 'select 车号 \"cart_number\",工序 \"last_proc\",机台 \"machine_name\" to_char(生产时间,\'YYYY-MM-DD HH24:mi:ss\') rec_time from VIEW_CARTFINDER where key_recid in (select max(key_recid) key_recid from VIEW_CARTFINDER t where 车号 in (?) group by 车号) and 车号 in (?)', 'cart1,cart2', '', '2018-04-13 22:22:06', '2018-04-13 22:25:48');
