...
INSERT INTO `sys_api` VALUES ('85', '0000000002', '49', '增加冠字号段验证计划', '2df9bb813c', 'insert into print_newproc_plan(alpha_num,date_type,num1,num2,proc_name,proc_stream1,prod_id,reason,rec_time ) values (?,?,?,?,?,?,?,?,?)', 'alpha_num,date_type,num1,num2,proc_name,proc_stream1,prod_id,reason,rec_time', '', '2018-04-11 08:57:35', '2018-04-11 08:57:35');
